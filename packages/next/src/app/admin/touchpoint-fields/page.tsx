...
export default function TouchpointFieldsPage() {
  ...
  const autoPopulateFields = fields.filter(
    (f) => f.trigger.autoPopulate,
  ).length;
      ...
      <Stack space="600">
        ...
        <Stack space="300">
          ...
          <InlineStack gap="400" verticalAlign="center">
            <Stack space="200">
              ...
              <Text>
                Manage AI-assisted custom fields that trigger automatically in
                touchpoint notes
              </Text>
            </Stack>
            <Button
              variant="primary"
              onPress={() => alert('Create field coming soon')}
            >
              + Create Field
            </Button>
          </InlineStack>
        ...
        >
          <InlineStack gap="300">
            ...
            <Stack space="200">
              <div>
                <Text weight="600" style={{ marginRight: '8px' }}>
                  What are Smart Fields?
                </Text>
                <Text color="link" style={{ cursor: 'pointer' }}>
                  Learn more
                </Text>
              </div>
              <Text variant="sm" color="subdued">
                Smart Fields eliminate tedious form-filling by automatically
                detecting and populating custom fields based on what case
                workers write in their touchpoint notes. Instead of facing 50+
                empty form fields, workers just write naturally and AI suggests
                only the 2-3 relevant fields with pre-filled values.
              </Text>
            </Stack>
          </InlineStack>
        </div>
        ...
        <div>
          <Text variant="sm" style={{ marginBottom: '12px', fontWeight: 500 }}>
            Filter by category:
          </Text>
          <div
            style={{
              ...
              style={{
                ...
                border:
                  selectedCategory === 'all'
                    ...
                    : '1px solid #e5e7eb',
                backgroundColor:
                  selectedCategory === 'all' ? '#3b82f6' : 'white',
                ...
                style={{
                  ...
                  border:
                    selectedCategory === key
                      ...
                      : '1px solid #e5e7eb',
                  backgroundColor:
                    selectedCategory === key ? '#3b82f6' : 'white',
